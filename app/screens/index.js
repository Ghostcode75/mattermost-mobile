...
export function registerScreens(store, Provider) {
    ...
    Navigation.registerComponent('Root', () => wrapper(Root), () => Root); // Navigation.registerComponent('Root', () => wrapper(require('app/screens/root').default), () => require('app/screens/root').default);
